...
class MyApp  {
    ...
    init() {
        ...
        this.renderer.getSize(this.originalSize)
    ...
    initCameras() {
        ...
        perspective1.position.set(100,30,100)
        ...
        if (this.lastCameraName !== this.activeCameraName) {
            ...
            if (this.controls === null) {
                ...
                this.controls.addEventListener( 'change', function() {
                    try {
                        if (obj.contents !== null && obj.contents!== undefined) 
                            obj.contents.updateOnControlsChange()
                    }
                    catch(e) { }
                });
            }
    ...
    onResize() {
        if (this.activeCamera !== undefined && this.activeCamera !== null) {
            ...
            console.info("Resize called: " + window.innerWidth + " " + window.innerHeight + " " + (window.innerWidth / window.innerHeight))
    ...
    */
    render () {
        ...
        try {
            this.contents.postRenderUpdate()
        }
        catch (e) {
            // console.debug(e)
        }
